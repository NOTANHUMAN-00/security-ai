            ...
            <div className="footer__container container">
                    ...
                    <div className="footer__brand">
                        <a href="#home" className="footer__logo">
                            ...
                            <span className="footer__logo-text">
                                Sentinel<span className="footer__logo-x">-X</span>
                            </span>
                        </a>
                        <p className="footer__tagline">
                            Open-source AI-powered WAF. Free forever. Build the future of web security together.
                        </p>
                        <div className="footer__social">
                            <a href="#github" className="footer__social-link" aria-label="GitHub">
                            ...
                            <a href="#discord" className="footer__social-link" aria-label="Discord">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="footer__bottom">
                    <p className="footer__copyright">
                        © 2026 Y-NINE LABS. Open Source under MIT License.
                    </p>
